...
${BROWSER}                      chrome
${username}                     dkellogg@copado.com.salesengineering
${login_url}                    https://dksales.lightning.force.com/lightning/setup/SetupOneHome/home                             # Salesforce instance. NOTE: Should be overwritten in CRT variables
${home_url}                     ${login_url}/lightning/page/home
${sandbox_url}                  
${sandbox_username}             dkellogg@copado.com.salesengineering
${File_name}                    dev2_custom_labels.csv
